...
PROGRAM_SO="contract/target/deploy/blockral.so"
PROGRAM_KEYPAIR="contract/target/deploy/blockral-keypair.json"
FRONTEND_DIR="frontend"
IDL_FILE="contract/target/idl/blockral.json"

echo "=== Blockral Deployment ==="
echo ""
...
echo "Website: https://blockral.com"
